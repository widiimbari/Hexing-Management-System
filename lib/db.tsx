...
import { PrismaClient as AssetClient } from "../generated/asset-client-v11";
...
const globalForPrisma = globalThis as unknown as {
  ...
  prismaAssetV11: AssetClient | undefined;
...
export const dbAsset = globalForPrisma.prismaAssetV11 ?? new AssetClient();
...
if (process.env.NODE_ENV !== "production") {
  ...
  globalForPrisma.prismaAssetV11 = dbAsset;
