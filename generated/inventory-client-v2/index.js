...
path.join(process.cwd(), "generated/inventory-client-v2/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "generated/inventory-client-v2/schema.prisma")
